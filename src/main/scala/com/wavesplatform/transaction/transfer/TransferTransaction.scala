...
<<<<<<< HEAD:src/main/scala/scorex/transaction/transfer/TransferTransaction.scala
    (validateAmount(amount, "Agate"), validateFee(feeAmount), validateAttachment(attachment), validateSum(Seq(amount, feeAmount)))
      .mapN { case _ => () }
=======
    (
...
>>>>>>> 4f3106f04982d02459cdc4705ed835b976d02dd9:src/main/scala/com/wavesplatform/transaction/transfer/TransferTransaction.scala
      .toEither
      .leftMap(_.head)
  }
